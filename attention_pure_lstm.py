...
from tensorflow.keras.layers import LSTM, Dense, Concatenate, TimeDistributed, Flatten, Input, Dropout
...
class pure_LSTM():
    ...
    def train_test_loop(self, loop=10, units=10, act_f=0, N_layer=1, lr=0.1, dropout=0.0, recurrent_dropout=0.0, epochs=600, batch_size=160):
        '''
        model create
        '''
        model_input = []
        ...
        model train
        '''
        get_best_model = ModelCheckpoint('attention_pure_lstm.h5', monitor='val_loss', save_best_only=True)
