...
class opt_binary_LSTM():
    ...
    def train_test(self, lstm_units=100, lstm_act_f=0, lstm_layer=1, lstm_dropout=0.0, lstm_recurrent_dropout=0.0, att=0,
        ...
        model_input = []
        model_output = []
        lstm_act_f = ['tanh', 'selu', 'relu', 'sigmoid'][lstm_act_f]
        ...
        '''
        if self.denoise:
            get_best_model = ModelCheckpoint('./model/checkpoint/for_opt_denoise_binary_{}.h5'.format(self.wavelet), monitor='accuracy', save_best_only=True)
        else:
            get_best_model = ModelCheckpoint('./model/checkpoint/for_opt_binary_{}.h5'.format(self.wavelet), monitor='accuracy', save_best_only=True)
